...
class SubscriptionScreen extends StatelessWidget {
      ...
      body: Stack(
        children: [
          AnimatedGradientBackground(
            colors: GradientThemes.purpleTheme,
  ...
  Widget _buildPlanCard(
    ...
    return GlassContainer(
      ...
      borderRadius: 16,
      blur: 12,
      opacity: plan.isPopular ? 0.25 : 0.2,
      padding: const EdgeInsets.all(16.0),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: plan.isPopular ? Colors.amber : Colors.white,
                foregroundColor: plan.isPopular ? Colors.white : Colors.purple,
